...
where TEntity : BaseEntity, new()
{
    ...
    internal async Task<HttpResponseMessage> PostAsJsonAsync(string uri, string json) => await Client.PostAsync(uri, new StringContent(json, Encoding.UTF8, "application/json"));
