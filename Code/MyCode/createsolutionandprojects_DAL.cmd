rem Use a Global JSON file to Pin the .NET Core SDK Version
dotnet new globaljson --sdk-version 8.0.100 --roll-forward feature
rem Create a NuGet Config
...
rem Create the AutoLot.Models class library
...
rem Add the required NuGet packages to the project
...
rem Add the project to the solution and project references
