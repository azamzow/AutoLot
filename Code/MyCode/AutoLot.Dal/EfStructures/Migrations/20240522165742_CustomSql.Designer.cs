...
namespace AutoLot.Dal.EfStructures.Migrations
{
	...
	[Migration("20240716200723_CustomSql")]
...
#pragma warning disable 612, 618
			...
			modelBuilder.Entity("Driver", b =>
			{
				...
				b.ComplexProperty<Dictionary<string, object>>("PersonInformation", "Driver.PersonInformation#Person", b1 =>
				{
					b1.IsRequired();
			...
			modelBuilder.Entity("AutoLot.Models.Entities.CarDriver", b =>
			{
				...
				b.HasOne("Driver", "DriverNavigation")
					.WithMany("CarDrivers")
